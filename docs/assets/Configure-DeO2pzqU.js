import{j as e}from"./jsx-runtime-Cw8dmJ57.js";import{useMDXComponents as r}from"./index-y0ifwxXQ.js";import{M as l}from"./index-Ba9eJjej.js";import"./index-C57_-39e.js";import"./iframe-DqsvfuQL.js";import"./index-B_KJRbAy.js";import"./index-D9XJHvQl.js";import"./index-NOh9rqHv.js";import"./index-ogSvIofg.js";function i(s){const n={a:"a",br:"br",code:"code",h2:"h2",h3:"h3",hr:"hr",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Introduction"}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#introduction",children:"Introduction"})}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#contributing",children:"Contributing"})}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Headless Components"}),e.jsx(n.br,{}),`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"DRUIDS-Inspired Architecture"}),e.jsx(n.br,{}),`
`,"Built with the same modular philosophy as DataDog's DRUIDS, emphasizing clean separation of logic and presentation."]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Automatic Theme Detection"}),e.jsx(n.br,{}),`
`,"Components automatically adapt to OS-level light/dark theme preferences via CSS media queries."]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Accessibility First"}),e.jsx(n.br,{}),`
...
`,e.jsx(n.li,{children:"Perequisites"}),`
`]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.code,{children:"node>=18"})}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"yarn"})," or ",e.jsx(n.code,{children:"npm"})]}),`
`,e.jsxs(n.li,{children:["a working project with:",`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"react >= 16.8"}),`
`]}),`
`]}),`
`]}),`
