...
import { getBaseProps, MarginProps, PaddingProps, LEVEL_SHADOWS } from '../../../helpers'
...
function Panel(props: Props) {
  ...
  const [extraClasses, restProps] = getBaseProps({ ...rest, padding: padding}, ["margin", "padding"])
    ...
    <Comp
      ...
      className={classNames(
        ...
        `${BLOCK}--shadow-level-${shadowLevel}`,
        {
          ...
          [`${BLOCK}--should-shrink-to-content`]: shouldShrinkToContent,
        },
        extraClasses,
        className
      )}>
