const genSetCookie =
    (converter, defaultAttributes) => (name, value, options) => {
        if (typeof document !== 'undefined') {
            ...
            document.cookie =
                name + '=' + converter.write(value, name) + cookieString
        }
    }

const genGetCookie =
    (converter) =>
    (name?: string): string | { [key: string]: string } | undefined => {
        //@ts-ignore
    ...
    return Object.create(
        {
            ...
            withAttributes(attributes = {}) {
                return initCookieManager(converter, {
                    ...defaultAttributes,
                    ...attributes,
                })
            },
            withConverter(newConverter = {}) {
                return initCookieManager(
